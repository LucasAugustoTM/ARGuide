...
Os assets padrão incluídos na release foram feitos para uso específico no laboratório Fablab na PUCRS. Há releases em Português e Inglês. A ordem padrão já inclusa pode ser revertida
...
The default assets included with the release were made for specific use at the Fablab laboratory at PUCRS. There are Portuguese and English releases. The default order already included 
can be reverted back to normal  at runtime in the "Sequence Configuration" menu. There is currently a release for Android systems, with plans for a future iOS release.
...
<p align="center">
<img src="arguidegif.gif" width=250>
</p>
